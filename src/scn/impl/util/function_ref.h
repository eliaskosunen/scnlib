...
namespace scn {
    ...
    namespace impl {
        namespace fnref_detail {
            ...
            template <class T>
            using param_t = typename std::invoke_result_t<
                decltype(select_param_type<T>)>::type;
            ...
            struct base {
                union storage {
                    ...
                    template <typename T,
                              std::enable_if_t<std::is_object_v<T>>* = nullptr>
        ...
        class function_ref<Sig, R(Args...)> : fnref_detail::base {
            ...
            using fwd_t = R(storage,
                            fnref_detail::param_t<Args>...) noexcept(noex);
        ...
        public:
            ...
            /*implicit*/ function_ref(F* f) noexcept
                : m_fptr([](storage fn,
                            fnref_detail::param_t<Args>... args) noexcept(noex)
                             -> R {
