...
namespace scn {
    ...
    namespace impl {
        ...
        static_assert(ranges::input_range<take_width_view<
                          ranges_polyfill::views::all_t<std::string_view>>>);
        static_assert(ranges::forward_range<take_width_view<
                          ranges_polyfill::views::all_t<std::string_view>>>);
        static_assert(ranges::bidirectional_range<take_width_view<
                          ranges_polyfill::views::all_t<std::string_view>>>);
